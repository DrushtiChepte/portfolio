...
const About = () => {
  return (
    <>
      <SEO
        title="About Drushti Chepte | Portfolio"
        description="Learn more about Drushti Chepte, a passionate web developer combining mechanical engineering and modern web development."
        keywords="About Drushti Chepte, web developer, mechanical engineering, portfolio"
        url="https://drushtichepte.me/#about"
      />
                ...
                <div className="relative w-full h-full rounded-xl flex items-end overflow-hidden">
                  ...
                  <div className="relative p-6 z-10 text-sm flex flex-col items-end gap-4">
                    ...
                    <p>
                      ...
                      been learning through practice—building projects,
                      exploring online resources, and figuring things out one
                      step at a time. I really enjoy the process of turning
                      ideas into working websites, and seeing them come to life
                      on the screen.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative w-full h-full p-6 text-white flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-4 text-sm">
                    <div>
                      ...
                      >
                        <span className="cursor-pointer hover:text-p3">
                          view
                        </span>
