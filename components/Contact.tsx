...
const Contact = () => {
  return (
    <>
      <SEO
        title="Contact Drushti Chepte | Portfolio"
        description="Get in touch with Drushti Chepte for web development projects or collaborations."
        keywords="Contact, Drushti Chepte, web developer, collaboration, portfolio"
        url="https://drushtichepte.me/#contact"
      />
