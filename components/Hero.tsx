  ...
  return (
    <>
      <SEO
        ...
        description="Official portfolio of Drushti Chepte — a passionate web developer and engineering student."
        keywords="Drushti Chepte, portfolio, web developer, React, Next.js, frontend developer"
        ...
        <div className="flex flex-1/12 justify-center text-center relative z-10  min-w-full">
          ...
          >
            ...
            <div className="flex justify-center items-center space-x-6 pt-10">
              <a
                href="/DrushtiChepte_FDResume_2025.pdf"
                download
                aria-label="Download Drushti Chepte resume"
              >
                <button className="relative inline-flex h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none cursor-pointer">
