...
const Projects = () => {
  return (
    <>
      <SEO
        title="Projects by Drushti Chepte | Portfolio"
        description="Explore the latest web development projects and creative coding works by Drushti Chepte."
        keywords="Projects, portfolio, web development, React, Next.js, coding"
        url="https://drushtichepte.me/#projects"
      />
